...
export const projects = [
    ...
    },
    {
      ...
      description: "A Model Context Protocol (MCP) that analyzes Spotify listening history, revealing listener identity, taste shifts, and future music trends without Spotify Premium.",
