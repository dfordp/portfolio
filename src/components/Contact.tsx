    ...
    <div className='md:my-24 md:px-24'>
      ...
      <div className='md:my-8 md:px-20'>
        <p className="leading-7 [&:not(:first-child)]:mt-4 text-xs md:text-base dark:text-gray-400">
            ...
            You can also check out my <a href="https://docs.google.com/document/d/1K93ilxfHvfv7_4ueDFV9CrUaHQnr7Thd/edit?usp=sharing&ouid=113178507201676811124&rtpof=true&sd=true" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">resume </a> 
